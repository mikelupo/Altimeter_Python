...
class clock:
    ...
    def __init__(self,root,deltahours = 0):
        self.world       = [-1,-1,1,1]
        self.bgcolor     = '#000000'
        self.bgimage     = os.path.join(os.path.dirname(__file__), "Altimeter_template.jpg")
        ...
        #hitting the escape key kills the clock. 
        ...
        #self.canvas.create_image(0, 0, image=self.background_image, anchor = NW, tags="IMG")
...
#         self.canvas.create_text(50,50, text="Whiskey Tango Foxtrot", fill=self.timecolor)
#         self.canvas.pack(fill=BOTH, expand=YES)
        sc = self.canvas
        sc.delete(self._ALL)
